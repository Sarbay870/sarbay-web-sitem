...
# NOT: Google Drive kütüphanelerini sildik, gerek kalmadı.
...
# =========================================================
# === 👑 SAYFA YOLLARI (ROUTES) - BURASI GÜNCELLENDİ 👑 ===
# =========================================================
...
# --- 👑 DERSLER SAYFASI (YENİ - KLASÖRDEN OKUR) 👑 ---
@app.route('/dersler')
def dersler_sayfasi():
    klasor_yolu = os.path.join(app.root_path, 'static', 'dersler')
    dosyalar = []
    ...
    dosyalar.sort()
    return render_template('dersler.html', dosya_listesi=dosyalar, baslik="Ders Notları")

# --- 👑 AHLAK METİNLERİ SAYFASI 👑 ---
...
# --- 👑 PEYGAMBERİMİZİN HAYATI SAYFASI 👑 ---
